...
**[View Live Application →](https://your-app-url-here.streamlit.app)**
...
**Ernesto Bayon**
- GitHub: [@juanbayonugarte-source](https://github.com/juanbayonugarte-source)
- Project: [Rental Value Analyzer](https://github.com/juanbayonugarte-source/RENT-ANALYZER)
...
This project was developed as a final project for Data Analytics, demonstrating:
- API integration and data collection
